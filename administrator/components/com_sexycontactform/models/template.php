...
class SexyContactFormModelTemplate extends JModelAdmin
{
	/**
	 ...
	 * @since	1.6
	 */
	public function getTable($type = 'Template', $prefix = 'SexyContactFormTable', $config = array()) 
	{
	...
	{
		// Get the form.
		$form = $this->loadForm('com_sexycontactform.template', 'template', array('control' => '', 'load_data' => $loadData));
		if (empty($form)) 
		{
			return false;
		}
