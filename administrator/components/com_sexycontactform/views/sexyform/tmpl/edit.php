...
foreach($this->form->getFieldset() as $field): ?>
			...
			<?php 
				...
				echo $field->input;
				if($qq == 7) {?>
					<a style="float: left;margin-top: 7px;" href="http://2glux.com/projects/sexy-contact-form/demo" target="_blank">See Templates Demo</a>
				<?php }
			?>
			</li>
<?php $qq ++;
					...
					<div class="tab-pane active" id="details">
						<div class="control-group">
							...
							foreach($this->form->getFieldset() as $field): ?>
								...
								<?php if($qq == 7) {?>
									<a href="http://2glux.com/projects/sexy-contact-form/demo" target="_blank">See Templates Demo</a>
								<?php }?>
								</div>
