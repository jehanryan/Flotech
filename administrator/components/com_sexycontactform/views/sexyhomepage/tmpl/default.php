...
<div id="cpanel">
	<div class="icon">
		<a href="index.php?option=com_sexycontactform&view=sexyforms" title="<?php echo JText::_( 'COM_SEXYCONTACTFORM_SUBMENU_FORMS' ); ?>">
			<table style="width: 100%;height: 100%;text-decoration: none;">
				<tr>
					<td align="center" valign="middle">
						<img src="components/com_sexycontactform/assets/images/template.png" /><br />
						<?php echo JText::_( 'COM_SEXYCONTACTFORM_SUBMENU_FORMS' ); ?>
					</td>
				</tr>
			</table>
		</a>
...
<div id="cpanel">
	<div class="icon">
		<a href="index.php?option=com_sexycontactform&view=sexyfields" title="<?php echo JText::_( 'COM_SEXYCONTACTFORM_SUBMENU_FIELDS' ); ?>">
			<table style="width: 100%;height: 100%;text-decoration: none;">
				<tr>
					<td align="center" valign="middle">
						<img src="components/com_sexycontactform/assets/images/template.png" /><br />
						<?php echo JText::_( 'COM_SEXYCONTACTFORM_SUBMENU_FIELDS' ); ?>
					</td>
				</tr>
			</table>
		</a>
...
<div id="cpanel">
	<div class="icon" style="float: right;">
		<a href="<?php echo JText::_( 'COM_SEXYCONTACTFORM_SUBMENU_RATE_US_LINK' ); ?>" target="_blank" title="<?php echo JText::_( 'COM_SEXYCONTACTFORM_SUBMENU_RATE_US_DESCRIPTION' ); ?>">
			<table style="width: 100%;height: 100%;text-decoration: none;">
				<tr>
					<td align="center" valign="middle">
						<img src="components/com_sexycontactform/assets/images/icon-star-48.png" /><br />
						<?php echo JText::_( 'COM_SEXYCONTACTFORM_SUBMENU_RATE_US' ); ?>
					</td>
				</tr>
			</table>
		</a>
...
<div id="cpanel">
	<div class="icon" style="float: right;">
		<a href="<?php echo JText::_( 'COM_SEXYCONTACTFORM_SUBMENU_SUPPORT_FORUM_LINK' ); ?>" target="_blank" title="<?php echo JText::_( 'COM_SEXYCONTACTFORM_SUBMENU_SUPPORT_FORUM_DESCRIPTION' ); ?>">
			<table style="width: 100%;height: 100%;text-decoration: none;">
				<tr>
					<td align="center" valign="middle">
						<img src="components/com_sexycontactform/assets/images/forum.png" /><br />
						<?php echo JText::_( 'COM_SEXYCONTACTFORM_SUBMENU_SUPPORT_FORUM' ); ?>
					</td>
				</tr>
			</table>
		</a>
...
<div id="cpanel">
	<div class="icon" style="float: right;">
		<a href="<?php echo JText::_( 'COM_SEXYCONTACTFORM_SUBMENU_PROJECT_HOMEPAGE_LINK' ); ?>" target="_blank" title="<?php echo JText::_( 'COM_SEXYCONTACTFORM_SUBMENU_PROJECT_HOMEPAGE_DESCRIPTION' ); ?>">
			<table style="width: 100%;height: 100%;text-decoration: none;">
				<tr>
					<td align="center" valign="middle">
						<img src="components/com_sexycontactform/assets/images/project.png" /><br />
						<?php echo JText::_( 'COM_SEXYCONTACTFORM_SUBMENU_PROJECT_HOMEPAGE' ); ?>
					</td>
				</tr>
			</table>
		</a>
