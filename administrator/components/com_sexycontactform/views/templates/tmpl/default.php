	...
	<table class="adminlist">
		<thead>
			<tr>
				...
				<th>
					<?php echo JHtml::_('grid.sort', 'COM_SEXYCONTACTFORM_NAME', 'st.name', $listDirn, $listOrder); ?>
				</th>
				<th width="5%">
		...
		foreach ($this->items as $i => $item) :
			...
			<tr class="row<?php echo $i % 2; ?>">
				...
				<td>
					<a href="<?php echo JRoute::_('index.php?option=com_sexycontactform&task=template.edit&id='.(int) $item->id); ?>">
