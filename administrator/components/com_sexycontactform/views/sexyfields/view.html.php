...
class SexyContactFormViewSexyFields extends JViewLegacy {
    ...
    public function display($tpl = null) {
    	...
    	if(JV == 'j2') {
    		...
    		JHtmlSidebar::addFilter(
    				JText::_('COM_SEXYCONTACTFORM_SELECT_TYPE'),
    				'filter_type_id',
    ...
    {
    	JToolBarHelper::addNew('sexyfield.add');
    	JToolBarHelper::editList('sexyfield.edit');
	    	
		JToolBarHelper::divider();
 		JToolBarHelper::publish('sexyfields.publish', 'JTOOLBAR_PUBLISH', true);
		JToolBarHelper::unpublish('sexyfields.unpublish', 'JTOOLBAR_UNPUBLISH', true);
	    
    	if ($this->state->get('filter.published') == -2) {
    		JToolBarHelper::deleteList('', 'sexyfields.delete', 'JTOOLBAR_EMPTY_TRASH');
    		JToolBarHelper::divider();
    	}
    	else {
    		JToolBarHelper::trash('sexyfields.trash');
    		JToolBarHelper::divider();
    	}
    ...
    protected function getSortFields()
    {
    	return array(
    			...
    			'type' => JText::_('COM_SEXYCONTACTFORM_TYPE'),
