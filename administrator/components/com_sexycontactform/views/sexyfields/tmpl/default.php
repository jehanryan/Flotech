	...
	<fieldset id="filter-bar">
		...
		<div class="filter-select fltrt">
			...
			<select name="filter_form_id" class="inputbox" onchange="this.form.submit()">
				<option value=""><?php echo JText::_('COM_SEXYCONTACTFORM_SELECT_FORM');?></option>
			...
			<select name="filter_type_id" class="inputbox" onchange="this.form.submit()">
				<option value=""><?php echo JText::_('COM_SEXYCONTACTFORM_SELECT_TYPE');?></option>
	...
	<table class="adminlist">
		<thead>
			<tr>
				...
				<th width="10%">
					<?php echo JHtml::_('grid.sort', 'COM_SEXYCONTACTFORM_TYPE', 'type', $listDirn, $listOrder); ?>
				</th>
				<th width="20%">
