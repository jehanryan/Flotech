...
<form action="<?php echo JRoute::_('index.php?option=com_sexycontactform&layout=add&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="adminForm">
	<fieldset class="adminform">
		<legend><?php echo JText::_( 'COM_SEXYCONTACTFORM_DETAILS' ); ?></legend>
...
?>
<form action="<?php echo JRoute::_('index.php?option=com_sexycontactform&layout=add&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="adminForm" class="form-validate form-horizontal">
	<div class="row-fluid">
		<!-- Begin Newsfeed -->
