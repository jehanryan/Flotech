...
$cssFile = JURI::base(true).'/components/com_sexycontactform/assets/css/colorpicker.css';
$document->addStyleSheet($cssFile, 'text/css', null, array());

$cssFile = JURI::base(true).'/components/com_sexycontactform/assets/css/layout.css';
$document->addStyleSheet($cssFile, 'text/css', null, array());

$cssFile = JURI::base(true).'/components/com_sexycontactform/assets/css/temp_'.JV.'.css';
$document->addStyleSheet($cssFile, 'text/css', null, array());

$cssFile = JURI::base(true).'/components/com_sexycontactform/assets/css/jquery-ui-1.7.1.custom.css';
$document->addStyleSheet($cssFile, 'text/css', null, array());

$cssFile = JURI::base(true).'/components/com_sexycontactform/assets/css/ui.slider.extras.css';
$document->addStyleSheet($cssFile, 'text/css', null, array());

$cssFile = JURI::base(true).'/components/com_sexycontactform/assets/css/main.css';
$document->addStyleSheet($cssFile, 'text/css', null, array());
...
$jsFile = JURI::base(true).'/components/com_sexycontactform/assets/js/colorpicker.js';
$document->addScript($jsFile);

$jsFile = JURI::base(true).'/components/com_sexycontactform/assets/js/eye.js';
$document->addScript($jsFile);

$jsFile = JURI::base(true).'/components/com_sexycontactform/assets/js/utils.js';
$document->addScript($jsFile);

$jsFile = JURI::base(true).'/components/com_sexycontactform/assets/js/layout.js?ver=1.0.2';
//$document->addScript($jsFile);
?>
	...
	$(document).ready(function() {
		...
		$('.colorSelector').ColorPicker({
			...
			onChange: function (hsb, hex, rgb) {
				...
				//sexycontactform text inputs////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
					...
					$(".sexycontactform_input_element").css('backgroundColor' , backColor_);

					var back = '-webkit-linear-gradient(top, ' + $("#elem-132").val() + ', '  + $("#elem-133").val() + ')';
					$(".sexycontactform_input_element").css('background' , back);
					...
					$(".sexycontactform_input_element").css('filter' , fil);
					...
					$(".sexycontactform_input_element").css('borderColor' , borderColor);
					...
					$(".sexycontactform_input_element").css('boxShadow' , boxShadow);
					...
					$(".sexycontactform_input_element").css('color' , textColor);
					...
					$(".sexycontactform_input_element").css('textShadow' , textShadow);
				...
				//Error State////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
					...
					$(".sexycontactform_error .sexycontactform_input_element").css('color' , fontColor);
				}
				else if(roll == 184) { 
					...
					$(".sexycontactform_error .sexycontactform_input_element").css('textShadow' , textShadow);
				}
				/*pre text ********************************************************************************************************************************************************************************/
	        	else if(roll == 195) { 
		...
		function move_up(roll,val) {
			...
			//text inputs///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
				...
				$(".sexycontactform_input_element").css('fontSize' , val*1 + 1);
			}
			
			else if(roll == 168) {
				var w = val*1 + 1 + '%';
				$("input.sexycontactform_input_element").css('width' , w);
			}
			else if(roll == 169) {
				var w = val*1 + 1 + '%';
				$("textarea.sexycontactform_input_element").css('width' , w);
			}
			else if(roll == 170) {
				$("textarea.sexycontactform_input_element").css('height' , val*1 + 1);
			}
		...
		$("#elem-136").change(function() {
			var borderStyle = $(this).val();
			$(".sexycontactform_input_element").css('border' , $("#elem-135").val() + 'px ' +  borderStyle + $("#elem-134").val());
		})
		$("#elem-152").blur(function() {
			$(".sexycontactform_input_element").css('fontFamily' , $(this).val());
		})
		$("#elem-149").change(function() {
			$(".sexycontactform_input_element").css('fontWeight' , $(this).val());
		})
		$("#elem-150").change(function() {
			$(".sexycontactform_input_element").css('fontStyle' , $(this).val());
		})
		$("#elem-151").change(function() {
			$(".sexycontactform_input_element").css('textDecoration' , $(this).val());
		})
	 		...
	 		<div class="sexycontactform_wrapper">
	 			<div class="sexycontactform_wrapper_inner">
		 			...
		 			<div class="sexycontactform_field_box">
		 				<label class="sexycontactform_field_name" for="sexycontactform_name">Name <span class="sexycontactform_field_required">*</span></label>
		 				<input class="sexycontactform_input_element" type="text" id="sexycontactform_name">
		 			</div>
		 			<div class="sexycontactform_field_box">
		 				<label class="sexycontactform_field_name" for="sexycontactform_email">Email <span class="sexycontactform_field_required">*</span></label>
		 				<input class="sexycontactform_input_element" type="text" id="sexycontactform_email">
		 			</div>
		 			<div class="sexycontactform_field_box">
		 				<label class="sexycontactform_field_name" for="sexycontactform_phone">Phone <span class="sexycontactform_field_required">*</span></label>
		 				<input class="sexycontactform_input_element" type="text" id="sexycontactform_phone">
		 			</div>
		 			<div class="sexycontactform_field_box sexycontactform_error">
		 				<label class="sexycontactform_field_name" for="sexycontactform_error">Error State <span class="sexycontactform_field_required">*</span></label>
		 				<input class="sexycontactform_input_element" type="text" id="sexycontactform_error">
		 			</div>
		 			<div class="sexycontactform_field_box">
		 				<label class="sexycontactform_field_name" for="sexycontactform_message">Message <span class="sexycontactform_field_required">*</span></label>
		 				<textarea class="sexycontactform_input_element" cols="30" rows="15" id="sexycontactform_message"></textarea>
		 			</div>
		 			<div class="sexycontactform_submit_wrapper">
		 				<input type="button" value="Send" class="sexycontactform_send"/>
	        ...
	        <?php 
	        	...
	        	*/
	        	...
	        	create_accordion('Font Styles','closed');
	        		...
	        		echo_size_tr('Font Size:','21',$styles[21],'8','26');
	        	...
	        	create_accordion('Font Styles','closed');
	        		...
	        		echo_size_tr('Font Size:','32',$styles[32],'8','26');
	        	...
	        	create_accordion('Font Styles','closed');
	        		...
	        		echo_size_tr('Font Size:','42',$styles[42],'8','26');
...
<input type="hidden" name="option" value="com_sexycontactform" />
...
textarea.sexycontactform_input_element {
...
.sexycontactform_input_element:hover,.sexycontactform_input_element:focus {
