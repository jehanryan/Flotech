			...
			({
				...
				success: function(data)
				{
					...
					if(sexycontactform_thank_you_text_array[form_id] != '')
						pre_element.show().html(sexycontactform_thank_you_text_array[form_id]);
					...
					//replace buttons 
					if(sexycontactform_redirect_enable_array[form_id] == 0) {
						send_new_button.show();
						send_button.hide();
					}
				},
				error: function()
	...
	$('.sexycontactform_send_new').click(function() {
		...
		({
			...
			success: function(data)
			{
				...
				//set token
				$('.sexycontactform_token').attr("name",data);
				
				//replace buttons
				send_new_button.hide();
				send_button.show();
				...
				//clear errors
				sexycontactform_field_box.removeClass('sexycontactform_error');
				
				//set pre text
				pre_element.html(sexycontactform_pre_text_array[form_id]);
				if(sexycontactform_pre_text_array[form_id] == '')
					pre_element.hide();
