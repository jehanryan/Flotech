...
qq.FileUploader = function (o)
{
	...
	qq.extend(this._options, {
		...
		template:'<div class="qq-uploader">' +
			'<div class="qq-upload-button btn"><span class="qq-upload-button-caption">' + Joomla.JText._('COM_FOXCONTACT_BROWSE_FILES') + '</span></div>' +
		...
		fileTemplate:'<li>' +
			...
			'<span class="qq-upload-failed-text">' + Joomla.JText._('COM_FOXCONTACT_FAILED') + '</span>' +
			'<span class="qq-upload-success-text">' + Joomla.JText._('COM_FOXCONTACT_SUCCESS') + '</span>' +
			'</li>',
...
function CreateUploadButton(uploadid, action, cid, mid, owner, id)
{
